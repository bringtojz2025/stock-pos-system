...
- ระบบการชำระเงิน
- พิมพ์ใบเสร็จ
- **✨ ระบบแคมเปญ**: สร้างโปรโมชั่นลดราคาชั่วคราว
  - กำหนดสินค้า ราคาโปรโมชั่น วันสิ้นสุด
  - เปิด/ปิดแคมเปญอัตโนมัติตามสต็อก
  - ตรวจสอบสต็อกแคมเปญแบบเรียลไทม์
  - ปิดแคมเปญโดยอัตโนมัติเมื่อสต็อกหมด
- **✨ ระบบคูปอง**: โค้ดลดราคา DISCOUNT05, DISCOUNT10
  - DISCOUNT05: ลดราคา 5% สำหรับยอด ≥ 200฿
  - DISCOUNT10: ลดราคา 10% สำหรับยอด ≥ 500฿
  - ตั้งค่าจำนวนลดและข้อความคูปอง
- **✨ ยกเลิกการทำธุรกรรม**: บันทึกการยกเลิกลงใน Google Sheet
  - แสดงข้อมูลการยกเลิกแบบชัดเจน
...
### ระบบแคมเปญ (Campaign Management)
1. ไปที่ Tab 🏪 POS → Settings
2. ดูแท็บ "แคมเปญ" (Campaigns)
3. จัดการแคมเปญ:
   - **เพิ่มแคมเปญใหม่**: ระบุสินค้า, ราคาโปรโมชั่น, วันสิ้นสุด, สต็อก, สถานะ
   - **แก้ไข**: เลือกแคมเปญ → ปรับปรุงข้อมูล
   - **ลบ**: เลือก → กดปุ่มลบ
4. ระบบจะ:
   - ตรวจสอบสต็อกแคมเปญเมื่อสแกน
   - ปิดแคมเปญโดยอัตโนมัติเมื่อสต็อก = 0
   - ใช้ราคาแคมเปญเฉพาะเมื่อแคมเปญเปิด

### ระบบคูปอง (Coupon System)
1. ไปที่ Tab 🏪 POS → Settings
2. ดูแท็บ "คูปอง" (Coupons)
3. ตั้งค่า:
   - **DISCOUNT05**: ระบุจำนวนลดและข้อความ
   - **DISCOUNT10**: ระบุจำนวนลดและข้อความ
4. ใช้งาน:
   - ใส่โค้ดคูปอง DISCOUNT05 หรือ DISCOUNT10 ในช่องคูปอง
   - ระบบคำนวณลดราคาอัตโนมัติ
   - แสดงสต์ทั้ง Subtotal → Discount → Final Amount
